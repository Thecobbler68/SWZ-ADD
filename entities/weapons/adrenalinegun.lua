...
if CLIENT then
	SWEP.PrintName = "'OCD' Regeneration Gun"
	SWEP.Description = "Fires a medical dart that regenerates the target's health for a short duration"
	SWEP.Slot = 4
	SWEP.SlotPos = 0
...
function SWEP:ShootBullets(dmg, numbul, cone)
	...
	local ent = ents.Create("adrenalinedart")
	if ent:IsValid() then
