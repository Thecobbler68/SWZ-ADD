...
GM.ItemCategories = {
	[ITEMCAT_GUNS] = "Pistols",
    [ITEMCAT_SMGS] = "SMGs",
    [ITEMCAT_ASSAULT] = "Assault Rifles",
    [ITEMCAT_RIFLES] = "Rifles",
    [ITEMCAT_SHOTGUNS] = "Shotguns",
    [ITEMCAT_PULSE] = "Pulse Weaponry",
...
GM:AddStartingItem("pshtr", "'Peashooter' P228", nil, ITEMCAT_GUNS, 40, "weapon_zs_peashooter")
GM:AddStartingItem("agentdualelites", "'Agent' Dual Elites (by Nocturne1501)", nil, ITEMCAT_GUNS, 40, "agent_dual_elites")
GM:AddStartingItem("btlax", "'Battleaxe' USP", nil, ITEMCAT_GUNS, 40, "weapon_zs_battleaxe")
GM:AddStartingItem("owens", "'Owens' Pistol", nil, ITEMCAT_GUNS, 40, "weapon_zs_owens")
GM:AddStartingItem("blstr", "'Blaster' Shotgun", nil, ITEMCAT_SHOTGUNS, 55, "weapon_zs_blaster")
GM:AddStartingItem("tossr", "'Tosser' SMG", nil, ITEMCAT_SMGS, 50, "weapon_zs_tosser")
GM:AddStartingItem("stbbr", "'Stubber' Scout", nil, ITEMCAT_RIFLES, 55, "weapon_zs_stubber")
GM:AddStartingItem("crklr", "'Crackler' FAMAS", nil, ITEMCAT_ASSAULT, 50, "weapon_zs_crackler")
GM:AddStartingItem("z9000", "'Z9000' Pulse Pistol", nil, ITEMCAT_PULSE, 50, "weapon_zs_z9000")

GM:AddStartingItem("2pcp", "36 Pistol Ammo", nil, ITEMCAT_AMMO, 15, nil, function(pl) pl:GiveAmmo((GAMEMODE.AmmoCache["pistol"] or 12) * 3, "pistol", true) end, "models/Items/BoxSRounds.mdl")
GM:AddStartingItem("2sgcp", "24 Shotgun Shells", nil, ITEMCAT_AMMO, 15, nil, function(pl) pl:GiveAmmo((GAMEMODE.AmmoCache["buckshot"] or 8) * 3, "buckshot", true) end, "models/Items/BoxBuckshot.mdl")
GM:AddStartingItem("2smgcp", "90 SMG Ammo", nil, ITEMCAT_AMMO, 15, nil, function(pl) pl:GiveAmmo((GAMEMODE.AmmoCache["smg1"] or 30) * 3, "smg1", true) end, "models/Items/BoxMRounds.mdl")
GM:AddStartingItem("2arcp", "90 Assault Rifle Ammo", nil, ITEMCAT_AMMO, 15, nil, function(pl) pl:GiveAmmo((GAMEMODE.AmmoCache["ar2"] or 30) * 3, "ar2", true) end, "models/Items/357ammobox.mdl")
GM:AddStartingItem("2rcp", "18 Rifle Ammo", nil, ITEMCAT_AMMO, 15, nil, function(pl) pl:GiveAmmo((GAMEMODE.AmmoCache["357"] or 6) * 3, "357", true) end, "models/Items/BoxSniperRounds.mdl")
GM:AddStartingItem("2pls", "90 Pulse Ammo", nil, ITEMCAT_AMMO, 20, nil, function(pl) pl:GiveAmmo((GAMEMODE.AmmoCache["pulse"] or 30) * 3, "pulse", true) end, "models/Items/combine_rifle_ammo01.mdl")
GM:AddStartingItem("3pcp", "60 Pistol Ammo", nil, ITEMCAT_AMMO, 20, nil, function(pl) pl:GiveAmmo((GAMEMODE.AmmoCache["pistol"] or 12) * 5, "pistol", true) end, "models/Items/BoxSRounds.mdl")
GM:AddStartingItem("3sgcp", "40 Shotgun Shells", nil, ITEMCAT_AMMO, 20, nil, function(pl) pl:GiveAmmo((GAMEMODE.AmmoCache["buckshot"] or 8) * 5, "buckshot", true) end, "models/Items/BoxBuckshot.mdl")
GM:AddStartingItem("3smgcp", "150 SMG Ammo", nil, ITEMCAT_AMMO, 20, nil, function(pl) pl:GiveAmmo((GAMEMODE.AmmoCache["smg1"] or 30) * 5, "smg1", true) end, "models/Items/BoxMRounds.mdl")
GM:AddStartingItem("3arcp", "150 Assault Rifle Ammo", nil, ITEMCAT_AMMO, 20, nil, function(pl) pl:GiveAmmo((GAMEMODE.AmmoCache["ar2"] or 30) * 5, "ar2", true) end, "models/Items/357ammobox.mdl")
GM:AddStartingItem("3rcp", "30 Rifle Ammo", nil, ITEMCAT_AMMO, 20, nil, function(pl) pl:GiveAmmo((GAMEMODE.AmmoCache["357"] or 6) * 5, "357", true) end, "models/Items/BoxSniperRounds.mdl")
GM:AddStartingItem("3pls", "150 Pulse Ammo", nil, ITEMCAT_AMMO, 20, nil, function(pl) pl:GiveAmmo((GAMEMODE.AmmoCache["pulse"] or 30) * 5, "pulse", true) end, "models/Items/combine_rifle_ammo01.mdl")
...
GM:AddStartingItem("bfmoveexpert", "Swift Packer", "You pack up items 50% faster.", ITEMCAT_TRAITS, 15, nil, function(pl) pl.BuffMovingExpert = true end, "models/healthvial.mdl")
GM:AddStartingItem("bffocused", "Focused", "You don't get dizzy when wounded.", ITEMCAT_TRAITS, 15, nil, function(pl) pl:SetFocused(true) end, "models/healthvial.mdl")
...
GM:AddStartingItem("bfregen", "Regenerative", "If you drop below 40 health, you will regenerate 2 health every 5 seconds.", ITEMCAT_TRAITS, 25, nil, function(pl) pl.BuffRegenerative = true end, "models/healthvial.mdl")
GM:AddStartingItem("bfsurv", "Survivor", "You earn extra 2 points per minute of not taking damage.", ITEMCAT_TRAITS, 20, nil, function(pl) pl.BuffSurvivor = true end, "models/healthvial.mdl")
...
GM:AddStartingItem("bfmurderer", "Murderer", "Backstabs with your knife deal triple damage instead of double damage.", ITEMCAT_TRAITS, 15, nil, function(pl) pl.BuffMurderer = true end, "models/weapons/w_knife_t.mdl")
...
GM:AddPointShopItem("glock3", "'Crossfire' Glock", nil, ITEMCAT_GUNS, 30, "weapon_zs_glock3")
GM:AddPointShopItem("magnum", "'Ricochet' Magnum", nil, ITEMCAT_GUNS, 35, "weapon_zs_magnum")
GM:AddPointShopItem("eraser", "'Eraser' Five-Seven", nil, ITEMCAT_GUNS, 35, "weapon_zs_eraser")
GM:AddPointShopItem("bystander", "'Bystander' Magnum", nil, ITEMCAT_GUNS, 40, "bystander_magnum")

GM:AddPointShopItem("uzi", "'Sprayer' MAC10", nil, ITEMCAT_SMGS, 70, "weapon_zs_uzi")
GM:AddPointShopItem("shredder", "'Shredder' MP5", nil, ITEMCAT_SMGS, 70, "weapon_zs_smg")
GM:AddPointShopItem("bulletstorm", "'Bullet Storm' P90", nil, ITEMCAT_SMGS, 70, "weapon_zs_bulletstorm")
GM:AddPointShopItem("silencer", "'Silencer' TMP", nil, ITEMCAT_SMGS, 70, "weapon_zs_silencer")
GM:AddPointShopItem("hunter", "'Hunter' AWP", nil, ITEMCAT_RIFLES, 70, "weapon_zs_hunter")

GM:AddPointShopItem("reaper", "'Reaper' UMP45", nil, ITEMCAT_SMGS, 80, "weapon_zs_reaper")
GM:AddPointShopItem("ender", "'Ender' Automatic Shotgun", nil, ITEMCAT_SHOTGUNS, 75, "weapon_zs_ender")
GM:AddPointShopItem("akbar", "'Akbar' AK47", nil, ITEMCAT_ASSAULT, 80, "weapon_zs_akbar")

GM:AddPointShopItem("stalker", "'Stalker' M4A1", nil, ITEMCAT_ASSAULT, 125, "weapon_zs_m4")
GM:AddPointShopItem("inferno", "'Inferno' AUG", nil, ITEMCAT_ASSAULT, 125, "weapon_zs_inferno")
GM:AddPointShopItem("annabelle", "'Annabelle' Rifle", nil, ITEMCAT_RIFLES, 100, "weapon_zs_annabelle")

GM:AddPointShopItem("crossbow", "'Impaler' Crossbow", nil, ITEMCAT_TOOLS, 175, "weapon_zs_crossbow")
GM:AddPointShopItem("newtonlauncher", "'Traitor' Newton Launcher", nil, ITEMCAT_TOOLS, 125, "traitor_newton_launcher")

GM:AddPointShopItem("sweeper", "'Sweeper' M3", nil, ITEMCAT_SHOTGUNS, 200, "weapon_zs_sweepershotgun")
GM:AddPointShopItem("boomstick", "Boom Stick", nil, ITEMCAT_SHOTGUNS, 200, "weapon_zs_boomstick")
GM:AddPointShopItem("slugrifle", "'Tiny' Slug Rifle", nil, ITEMCAT_RIFLES, 200, "weapon_zs_slugrifle")
GM:AddPointShopItem("pulserifle", "'Adonis' AR2", nil, ITEMCAT_PULSE, 225, "weapon_zs_pulserifle")

GM:AddPointShopItem("pistolammo", "12 Pistol Ammo", nil, ITEMCAT_AMMO, 5, nil, function(pl) pl:GiveAmmo(GAMEMODE.AmmoCache["pistol"] or 12, "pistol", true) end, "models/Items/BoxSRounds.mdl")
GM:AddPointShopItem("shotgunammo", "8 Shotgun Shells", nil, ITEMCAT_AMMO, 6, nil, function(pl) pl:GiveAmmo(GAMEMODE.AmmoCache["buckshot"] or 8, "buckshot", true) end, "models/Items/BoxBuckshot.mdl")
GM:AddPointShopItem("smgammo", "30 SMG Ammo", nil, ITEMCAT_AMMO, 6, nil, function(pl) pl:GiveAmmo(GAMEMODE.AmmoCache["smg1"] or 30, "smg1", true) end, "models/Items/BoxMRounds.mdl")
GM:AddPointShopItem("assaultrifleammo", "30 Assault Rifle Ammo", nil, ITEMCAT_AMMO, 6, nil, function(pl) pl:GiveAmmo(GAMEMODE.AmmoCache["ar2"] or 30, "ar2", true) end, "models/Items/357ammobox.mdl")
GM:AddPointShopItem("rifleammo", "6 Rifle Ammo", nil, ITEMCAT_AMMO, 6, nil, function(pl) pl:GiveAmmo(GAMEMODE.AmmoCache["357"] or 6, "357", true) end, "models/Items/BoxSniperRounds.mdl")
GM:AddPointShopItem("crossbowammo", "1 Crossbow Bolt", nil, ITEMCAT_AMMO, 5, nil, function(pl) pl:GiveAmmo(1, "XBowBolt", true) end, "models/Items/CrossbowRounds.mdl")
GM:AddPointShopItem("pulseammo", "30 Pulse Ammo", nil, ITEMCAT_AMMO, 6, nil, function(pl) pl:GiveAmmo(GAMEMODE.AmmoCache["pulse"] or 30, "pulse", true) end, "models/Items/combine_rifle_ammo01.mdl")
...
GM:AddPointShopItem("painpills", "Morphine", "Instantly heals 15 health.", ITEMCAT_AMMO, 20, nil, function(pl) pl:SetHealth(pl:Health() + 15) pl.BuffAntidote = true end, "models/props_lab/jar01a.mdl")
...
GM.RestrictedModels = {
    ...
    "models/player/e3assassin.mdl",
    "models/player/soldier_stripped.mdl",
    "models/l4d_player/t_arctic.mdl",
    "models/l4d_player/t_guerilla.mdl",
    "models/l4d_player/t_leet.mdl",
    "models/l4d_player/t_phoenix.mdl",
    "models/l4d2_player/t_leet.mdl",
    "models/l4d2_player/t_phoenix.mdl",
    "models/l4d2_player/t_guerilla.mdl",
    "models/l4d2_player/t_arctic.mdl"
}
...
GM.LastHumanSound = Sound("zombiesurvival/skin_on_our_teeth.mp3")
